    ...
    return (
                ...
                <div className="container px-5 py-24 mx-auto">
                    ...
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <h1 className=" text-3xl title-font font-medium mb-1">{petData.name}</h1>
                        <div className="flex mb-4">

                        
                        </div>
                        <span className="title-font font-medium text-2xl text-gray-900 dark:text-white">{petData.breed}</span>
                        <div className="flex flex-col"><br />
                           <p className="leading-relaxed">{petData.details}</p>
                            <span className="relative  inline-flex h-12 active:scale-95 transistion overflow-hidden rounded-lg p-[1px] focus:outline-none">
